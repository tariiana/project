...
namespace project_N
{
    public partial class Client : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "repairNasDataSet.Client". При необходимости она может быть перемещена или удалена.
            this.clientTableAdapter.Fill(this.repairNasDataSet.Client);
        ...
        private void удалитьЗаписьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (data.idIndex != "")
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("DELETE Client WHERE Id = '" + data.idIndex + "'", sqlConnection);
                    cmd.ExecuteNonQuery();
